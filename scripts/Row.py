...
HOUGH_RHO = 10  # Distance resolution of the accumulator in pixels
...
def save_image(image_name, image_data):
    ...
    image_name_new = os.path.join(image_out_path,
                                  "{0}{1}_{2}.jpg".format(str(save_image.IMAGE_INC), image_name, str(curr_image)))
...
if USE_KMEANS :
    ...
    imgfile = getRowLines(TGIcolor, TGIbinary)
