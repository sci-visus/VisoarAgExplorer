...
class ViSOARMapIRCalibrationWidget(QWidget):
    ...
    def createUI(self):
        ...
        self.targetLineEdit.setFixedSize(280, 40)
        self.targetLineEdit.resize(280, 40)

        self.targetBrowseBtn = QPushButton(". . .")
        self.targetBrowseBtn.setStyleSheet(GREEN_PUSH_SM_BUTTON)
        self.targetBrowseBtn.resize(180, 40)
        self.targetBrowseBtn.setFixedSize(180, 40)
        self.targetBrowseBtn.setFixedWidth(180)
        self.targetBrowseBtn.setFixedHeight(40)
        ...
        imageLocationLayout.addStretch(1)
        self.imageLabel = QLabel("MapIR Image Directory", self)
        self.imageLineEdit = QLineEdit(self)
        self.imageLineEdit.setFixedSize(280, 40)
        self.imageLineEdit.resize(280, 40)
        self.imageBrowseBtn = QPushButton(". . .")
        self.imageBrowseBtn.setStyleSheet(GREEN_PUSH_SM_BUTTON)
        self.imageBrowseBtn.resize(180, 40)
        self.imageBrowseBtn.setFixedSize(180, 40)
        self.imageBrowseBtn.setFixedWidth(180)
        self.imageBrowseBtn.setFixedHeight(40)
        ...
        self.layoutAllCameraLayout.addSpacerItem(self.spaceItem)
