...
class ViSOARMapIRCalibrationWidget(QWidget):
    def __init__(self, parent  ):
        ...
        self.mapIRCalibrationWidget = MAPIR_ProcessingDockWidget()
        self.createUI()
    ...
    def createUI(self):
        ...
        self.layoutH.addLayout(self.layout2)
        self.layoutH.addLayout(self.layout3)
        ...
        H1layout.addWidget(self.targetLineEdit)
        H1layout.addWidget(self.targetBrowseBtn)
        ...
        H2layout.addWidget(self.imageLineEdit)
        H2layout.addWidget(self.imageBrowseBtn)
        ...
        self.btnGenerate = QPushButton("Generate Calibration Parameters")
        ...
        self.layout.addWidget(self.targetLabel, Qt.AlignLeft)
        self.layout.addLayout(H1layout)
        self.layout.addWidget(self.imageLabel, Qt.AlignLeft)
        self.layout.addLayout(H2layout)
    ...
    def preProcessMapIRImagesWithTarget(self):
        ...
        if (self.parent.parent.tabAskSensor.comboBoxNewTab.currentText() == 'MAPIR and RGB') or (
            ...
            if (outdir is None):
                import glob
                listing = glob.glob(os.path.join(self.projectInfo.srcDir, 'Calibrated_*'))
    ...
    def genCalibration(self):
        ...
        self.CalibrationCameraModel = self.comboboxCameraModel
        self.CalibrationQRFile = self.targetLineEdit
        self.CalibrationFilter = self.comboboxCalibrationFilter
        self.CalibrationLens = self.comboboxCalibrationLens
        self.qrcoeffs = []
        ...
        self.mapIRCalibrationWidget.CalibrationInFolder = self.imageLineEdit

        self.preProcessMapIRImagesWithTarget()
        self.parent.curDir2.setText(self.mapIRCalibrationWidget.CalibrationInFolder.text())
        #self.close()
